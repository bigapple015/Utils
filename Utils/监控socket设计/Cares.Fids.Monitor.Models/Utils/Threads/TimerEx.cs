...
namespace Cares.Fids.Monitor.Models.Utils.Threads
{
    public class TimerEx:IDisposable
    {
        ...
        public TimerEx(TimerCallback callback, int delayTime, int period, object state = null)
        {
            _timer = new Timer(callback,state,delayTime,period);
        }

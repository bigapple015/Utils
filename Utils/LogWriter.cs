    ...
    public static class LogWriter
    {
        ...
        public static bool SendMail(string title, string msg)
        {
            try
            {
                ...
                //设置发送邮箱的用户名，发送邮箱的密码
                client.Credentials = new System.Net.NetworkCredential("luchunminglu@126.com", "558276344");
                client.DeliveryMethod = SmtpDeliveryMethod.Network;
                MailMessage mail = new MailMessage();
                //发件人地址
                mail.From = new MailAddress("luchunminglu@126.com");
                //设置收件人集合
                mail.To.Add("luchunminglu@126.com");
                //设置抄送人集合
                //mail.CC.Add();
                //邮件的标题
                mail.Subject = title;

...
namespace iFlyTek.ECSS30.Tool.SMSFilter
{
    ...
    public class SqlHelper
    {
        ...
        /// </summary>
        private string connectionString = @"Data Source=.\SQLEXPRESS;AttachDbFilename=""C:\Documents and Settings\Administrator\my documents\visual studio 2010\Projects\科大讯飞Demo\WebServiceDemo\App_Data\DemoServer.mdf"";Integrated Security=True;User Instance=True";
